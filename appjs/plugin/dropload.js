(function($){
    ...
    var args = {
            ...
            refreshDOM : '<div class="dropload-refresh"><i class="fa fa-arrow-down">&nbsp;&nbsp;下拉刷新</div>',    // 下拉DOM
            updateDOM : '<div class="dropload-update"><i class="fa fa-arrow-up">&nbsp;&nbsp;释放更新</div>',      // 更新DOM
            loadDOM : '<div class="dropload-load"><i class="fa fa-cloud-download">&nbsp;&nbsp;加载中</div>',         // 加载DOM
            direction : 'up',                                               // 加载内容方向
            distance : 15                                                   // 下拉距离
        },
        _startY = 0,
